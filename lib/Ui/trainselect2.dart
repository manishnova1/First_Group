...
class StationsListScreen2 extends StatefulWidget {
  String caseType;

  StationsListScreen2(this.caseType, {Key? key}) : super(key: key);

  @override
  _StationsListScreen2State createState() => _StationsListScreen2State();
}

class _StationsListScreen2State extends State<StationsListScreen2> {
  String menu = "";
  ...
  void initState() {
    ...
    if (widget.caseType == "PF") {
      caseTitle = "Penalty Fare Notice";
