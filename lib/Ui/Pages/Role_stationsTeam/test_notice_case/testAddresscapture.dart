...
class TestAddressCapture extends StatefulWidget {
  @override
  _TestAddressCaptureState createState() => _TestAddressCaptureState();
}

class _TestAddressCaptureState extends State<TestAddressCapture> {
  String menu = "";
                          ...
                          onPressed: () async {
                            ...
                            if (checkInternet) {
                              BlocProvider.of<AddressUfnBloc>(context)
                                  .add(AddressTestIdentityCheck2(context));
                            } else {
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        const TestMissingCustomerInformationPersonal()));
                          },
                          child: Text(
