...
class Test_Unpaid_PaymentDetails extends StatefulWidget {
  @override
  _Test_Unpaid_PaymentDetailsState createState() =>
      _Test_Unpaid_PaymentDetailsState();
}

class _Test_Unpaid_PaymentDetailsState
    extends State<Test_Unpaid_PaymentDetails> {
            ...
            onTap: () {
              if (dueController.text.isEmpty) {
                locator<ToastService>()
                    .showValidationMessage(context, 'Please enter fare due');
              } else if (recievedController.text.isEmpty) {
                locator<ToastService>().showValidationMessage(
                    context, 'Please enter amount received ');
