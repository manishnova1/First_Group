...
import 'package:railpaytro/bloc/test_bloc/test_submit_form_bloc.dart';
...
class TestZeroFareTicketInformation extends StatefulWidget {
  @override
  _TestZeroFareTicketInformationState createState() =>
      _TestZeroFareTicketInformationState();
}

class _TestZeroFareTicketInformationState
    extends State<TestZeroFareTicketInformation> {
