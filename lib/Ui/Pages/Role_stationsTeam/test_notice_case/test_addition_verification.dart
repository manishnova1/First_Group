...
class testAdditionVerification extends StatefulWidget {
  @override
  _testAdditionVerificationState createState() =>
      _testAdditionVerificationState();
}

class _testAdditionVerificationState extends State<testAdditionVerification> {
  ...
  Future<void> getVerificationType(BuildContext context, String reason) async {
    final result = await Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => verifilist("Test", "Verification Type", "")));
    setState(() {
  ...
  void initState() {
    ...
    var submitAddressMap =
        BlocProvider.of<AddressTestBloc>(context).submitAddressMap;
          ...
          InkWell(
            onTap: () {
              if (verificationType == null) {
                ...
                BlocProvider.of<TestSubmitFormBloc>(context).add(
                    TestAdditionalVerifyEvent(
                        context: context,
