...
import 'package:railpaytro/Ui/Pages/Role_stationsTeam/post_code_screen.dart';
import 'package:railpaytro/Ui/Pages/Role_stationsTeam/test_notice_case/testAddresscapture.dart';
...
class TestUnpaidFare extends StatefulWidget {
  String issueTitle;

  TestUnpaidFare(this.issueTitle, {Key? key}) : super(key: key);

  @override
  _TestUnpaidFareState createState() => _TestUnpaidFareState();
}

class _TestUnpaidFareState extends State<TestUnpaidFare> {
  String menu = "";
        ...
        builder: (context) {
          return AlertDialog(
            ...
            content: subheadingText(
                title:
                    "Enter Post Code and select the correct address from the list"),
            actions: [
              InkWell(
                  onTap: () {
                ...
                onTap: () {
                  if (postCodeSearch != "") {
                    ...
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => TestAddressCapture()));
                  } else {
