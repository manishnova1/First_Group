...
class MissingCustomerInformationPersona extends StatefulWidget {
  final Revpidentityarray? data;

  const MissingCustomerInformationPersona({Key? key, this.data})
      : super(key: key);

  @override
  _MissingCustomerInformationPersonaState createState() =>
      _MissingCustomerInformationPersonaState();
}

class _MissingCustomerInformationPersonaState
    extends State<MissingCustomerInformationPersona> {
