...
class MissingCustomerInformationContact extends StatefulWidget {
  const MissingCustomerInformationContact({Key? key}) : super(key: key);

  @override
  _MissingCustomerInformationContactState createState() =>
      _MissingCustomerInformationContactState();
}

class _MissingCustomerInformationContactState
    extends State<MissingCustomerInformationContact> {
