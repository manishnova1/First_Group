...
class Unpaid_attachments extends StatefulWidget {
  @override
  _Unpaid_attachmentsState createState() => _Unpaid_attachmentsState();
}

class _Unpaid_attachmentsState extends State<Unpaid_attachments> {
  ...
  _handleImageSelection(File selectedImage) {
    if (imageslist.length < 4) {
      BlocProvider.of<ImageSubmitBloc>(context).add(
    ...
    return Scaffold(
      bottomNavigationBar: Row(
        ...
        children: [
          ...
          BlocListener<ImageSubmitBloc, ImageSubmitState>(
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              return ListTile(
                                ...
                                trailing: BlocListener<ImageSubmitBloc,
                                        ImageSubmitState>(
                                    listener: (BuildContext context, state) {
                                    ...
                                    child: InkWell(
                                      onTap: () {
                                        BlocProvider.of<ImageSubmitBloc>(
                                                context)
                        ...
                        LargeSpace(),
                        MediumSpace(),
                        BlocBuilder<ImageSubmitBloc, ImageSubmitState>(
