...
class unpaidfareNoticeSuccessfull extends StatefulWidget {
  final String caseNumber;

  const unpaidfareNoticeSuccessfull({Key? key, required this.caseNumber})
      : super(key: key);

  @override
  _unpaidfareNoticeSuccessfullState createState() =>
      _unpaidfareNoticeSuccessfullState();
}

class _unpaidfareNoticeSuccessfullState
    extends State<unpaidfareNoticeSuccessfull> {
