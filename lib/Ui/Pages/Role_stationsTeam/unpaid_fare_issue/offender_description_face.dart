...
class OffenderDescriptionFace extends StatefulWidget {
  @override
  _OffenderDescriptionFaceState createState() =>
      _OffenderDescriptionFaceState();
}

class _OffenderDescriptionFaceState extends State<OffenderDescriptionFace> {
  ...
  Future<void> gethairData(BuildContext context, String reason) async {
    final result = await Navigator.push(
        ...
        MaterialPageRoute(
            builder: (context) =>
                pfn_offender_lookups_list("UFN", "Hair Colour and Style", "")));
    setState(() {
  ...
  Future<void> getEyeData(BuildContext context, String reason) async {
    final result = await Navigator.push(
        ...
        MaterialPageRoute(
            builder: (context) =>
                pfn_offender_lookups_list("UFN", "Eye Colour", "")));
    setState(() {
      if (result.toString() != "null") {
  ...
  Future<void> getGlassesData(BuildContext context, String reason) async {
    final result = await Navigator.push(
        ...
        MaterialPageRoute(
            builder: (context) =>
                pfn_offender_lookups_list("UFN", "Glasses", "")));
    setState(() {
      if (result.toString() != "null") {
  ...
  Future<void> getFacialData(BuildContext context, String reason) async {
    final result = await Navigator.push(
        ...
        MaterialPageRoute(
            builder: (context) =>
                pfn_offender_lookups_list("UFN", "Facial Hair", "")));
    setState(() {
      if (result.toString() != "null") {
                        ...
                        PrimaryButton(
                            ...
                            onAction: () {
                              if (selectedHairColor == null) {
                                ...
                                BlocProvider.of<SubmitFormBloc>(context)
