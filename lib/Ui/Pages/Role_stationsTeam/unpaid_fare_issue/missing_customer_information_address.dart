...
class MissingCustomerInformationAddress extends StatefulWidget {
  const MissingCustomerInformationAddress({Key? key}) : super(key: key);

  @override
  _MissingCustomerInformationAddressState createState() =>
      _MissingCustomerInformationAddressState();
}

class _MissingCustomerInformationAddressState
    extends State<MissingCustomerInformationAddress> {
            ...
            onTap: () {
              if (postCodeSearch != "") {
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const MissingCustomerInformationContact()));
              } else {
