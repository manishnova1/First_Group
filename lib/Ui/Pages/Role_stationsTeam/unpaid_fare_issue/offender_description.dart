...
class OffenderDescription extends StatefulWidget {
  @override
  _OffenderDescriptionState createState() => _OffenderDescriptionState();
}

class _OffenderDescriptionState extends State<OffenderDescription> {
  ...
  //       MaterialPageRoute(
  //           builder: (context) =>
  //               pfn_offender_lookups_list("UFN", "Ethnicity", "")));
  //   setState(() {
  ...
  Future<void> getBuildData(BuildContext context, String reason) async {
    final result = await Navigator.push(
        ...
        MaterialPageRoute(
            builder: (context) =>
                pfn_offender_lookups_list("UFN", "Build", "")));
    setState(() {
      if (result.toString() != "null") {
  ...
  Future<void> getOccupationData(BuildContext context, String reason) async {
    final result = await Navigator.push(
        ...
        MaterialPageRoute(
            builder: (context) =>
                pfn_offender_lookups_list("UFN", "Occupation", "")));
    setState(() {
      if (result.toString() != "null") {
