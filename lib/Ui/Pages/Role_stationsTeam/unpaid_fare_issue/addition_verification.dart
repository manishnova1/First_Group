...
class additionVerification extends StatefulWidget {
  @override
  _additionVerificationState createState() => _additionVerificationState();
}

class _additionVerificationState extends State<additionVerification> {
  ...
  Future<void> getVerificationType(BuildContext context, String reason) async {
    final result = await Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => verifilist("UFN", "Verification Type", "")));
    setState(() {
