...
class _JourneyDetailsState extends State<JourneyDetails> {
  ...
  Future<void> getIssueData(BuildContext context, String reason) async {
    final result = await Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => UfnLookupList("UFN", "Issuing Reason", "")));
    setState(() {
  ...
  Future<void> gettravelClass(BuildContext context, String reason) async {
    final result = await Navigator.push(
        ...
        MaterialPageRoute(
            builder: (context) =>
                travelClass("UFN", " Select Travel Class", "")));
    setState(() {
      if (result.toString() != "null") {
  ...
  Future<void> getTravelledTo(BuildContext context) async {
    final result = await locator<NavigationService>()
        .push(StationsListScreenRoute(caseType: "ufn"));
    setState(() {
      if (result.toString() != "null") {
          ...
          InkWell(
            onTap: () {
              if (travelFrom.isEmpty) {
                ...
                BlocProvider.of<JournyInfoBloc>(context).add(
