...
class MissingCustomerInformationPersonalHT extends StatefulWidget {
  final Revpidentityarray? data;

  const MissingCustomerInformationPersonalHT({Key? key, this.data})
      : super(key: key);

  @override
  _MissingCustomerInformationPersonalHTState createState() =>
      _MissingCustomerInformationPersonalHTState();
}

class _MissingCustomerInformationPersonalHTState
    extends State<MissingCustomerInformationPersonalHT> {
