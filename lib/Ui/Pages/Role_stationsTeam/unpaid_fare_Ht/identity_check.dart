...
import 'package:railpaytro/Ui/Pages/Role_stationsTeam/unpaid_fare_Ht/missing_customer_information_personal.dart';
import 'package:railpaytro/Ui/Pages/Role_stationsTeam/unpaid_fare_issue/journey_details.dart';
...
class IdentityCheckScreenHt extends StatefulWidget {
  final List<Revpidentityarray>? revpidentityarray;

  const IdentityCheckScreenHt({Key? key, this.revpidentityarray})
      : super(key: key);

  @override
  _IdentityCheckScreenHtState createState() => _IdentityCheckScreenHtState();
}

class _IdentityCheckScreenHtState extends State<IdentityCheckScreenHt> {
                                ...
                                onAction: () {
                                  if (selectedIndex != -1) {
                                    Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                            builder: (context) =>
                                                MissingCustomerInformationPersonalHT(
                                                  data:
