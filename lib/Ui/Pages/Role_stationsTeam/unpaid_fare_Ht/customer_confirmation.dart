...
import 'package:railpaytro/bloc/UFN_HT_BLoc/submit_form_bloc.dart';
...
class customerConfirmationHT extends StatefulWidget {
  @override
  _customerConfirmationHTState createState() => _customerConfirmationHTState();
}

class _customerConfirmationHTState extends State<customerConfirmationHT> {
  int _groupValue = -1;
...
//
  ...
  call(file) {
    BlocProvider.of<SubmitFormBlocHTHT>(context).add(CustomerSignEvent(
      context: context,
      image: file,
