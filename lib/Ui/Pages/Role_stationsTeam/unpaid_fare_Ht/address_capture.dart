...
class AddressCaptureHt extends StatefulWidget {
  @override
  _AddressCaptureHtState createState() => _AddressCaptureHtState();
}

class _AddressCaptureHtState extends State<AddressCaptureHt> {
  String menu = "";
                          ...
                          onPressed: () async {
                            ...
                            if (checkInternet) {
                              BlocProvider.of<AddressUfnBloc>(context)
                                  .add(AddressUfnIdentityCheckHt(context));
                            } else {
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        const MissingCustomerInformationPersonalHT()));
                          },
                          child: Text(
