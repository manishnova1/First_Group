...
import 'missing_customer_information_contact.dart';
import 'package:sizer/sizer.dart';

class MissingCustomerInformationAddressHT extends StatefulWidget {
  const MissingCustomerInformationAddressHT({Key? key}) : super(key: key);

  @override
  _MissingCustomerInformationAddressHTState createState() =>
      _MissingCustomerInformationAddressHTState();
}

class _MissingCustomerInformationAddressHTState
    extends State<MissingCustomerInformationAddressHT> {
            ...
            onTap: () {
              if (postCodeSearch != "") {
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const MissingCustomerInformationContactHt()));
              } else {
