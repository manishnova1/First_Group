...
import 'address_capture.dart';

class UnpaidFareHt extends StatefulWidget {
  String issueTitle;

  UnpaidFareHt(this.issueTitle, {Key? key}) : super(key: key);

  @override
  _UnpaidFareHtState createState() => _UnpaidFareHtState();
}

class _UnpaidFareHtState extends State<UnpaidFareHt> {
                ...
                onTap: () {
                  if (postCodeSearch == "") {
                    ...
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => AddressCaptureHt()));
                  }
                },
                child: Container(
                  padding: EdgeInsets.all(15),
