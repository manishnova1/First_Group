...
class ImageSubmitBlocHTHT extends Bloc<ImageSubmitEvent, ImageSubmitState> {
  UfnRepo ufnRepo;

  ImageSubmitBlocHTHT(this.ufnRepo) : super(ImageSubmitInitialState());
  ...
  Stream<ImageSubmitState> mapEventToState(ImageSubmitEvent event) async* {
    ...
    if (event is ImageDeleteEvent) {
      ...
      Navigator.push(event.context!,
          MaterialPageRoute(builder: (context) => Unpaid_PaymentDetailsHTHT()));
    }
  }
}
