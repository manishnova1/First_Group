...
import 'package:railpaytro/Ui/Pages/Role_stationsTeam/unpaid_fare_Ht/journey_details.dart';
import 'package:railpaytro/Ui/Pages/Role_stationsTeam/unpaid_fare_Ht/missing_customer_information_address.dart';
...
class InfoAddressBlocHT extends Bloc<InfoAddressEvent, InfoAddressState> {
  UfnRepo ufnRepo;

  InfoAddressBlocHT(this.ufnRepo) : super(InfoAddressLoadingState());
  ...
  Stream<InfoAddressState> mapEventToState(InfoAddressEvent event) async* {
    if (event is InfoPersonalButtonEvent) {
      ...
      Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) =>
                  const MissingCustomerInformationAddressHT()));
      ...
      Navigator.push(event.context,
          MaterialPageRoute(builder: (context) => JourneyDetailsHt()));
    }
  }
}
