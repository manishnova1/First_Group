...
class ZebraPrinter {
  ...
  Function? onChangePrinterHeadStatus;
  Function? onPermissionDenied;

  bool isRotated = false;

  ZebraPrinter(String id, this.onPrinterFound, this.onPrinterDiscoveryDone,
      this.onDiscoveryError, this.onChangePrinterStatus,this.onChangePrinterHeadStatus,
  ...
  unpair(String ipAddress) {
    channel.invokeMethod("unpairDevice", {"Address": ipAddress});
  }
  checkPrinterHeadStatus() {
    channel.invokeMethod("checkPrinterHeadStatus", null);
  }
  ...
  Future<dynamic> nativeMethodCallHandler(MethodCall methodCall) async {
    ...
    } else if (methodCall.method == "changePrinterHeadStatus") {
      onChangePrinterHeadStatus!(
