        ...
        try {
            ...
            if (pairedDevices.size() > 0) {
                for (BluetoothDevice device : pairedDevices) {
                    System.out.println("Device ip " + device.getAddress());
                    System.out.println("selected ip " + address);
                    System.out.println("device adress is equal " + device.getAddress().equals(address));
                    if(device.getAddress().equals(address)) {
                        try {
                            ...
                            System.out.println("Removing has been failed." + e.getMessage());
                        }
                    }
                }
            }
        } catch (Exception e) {
            System.out.println("exception while unpairing"+ e.getMessage());
        }
    }
